...
const cssDeclerationSorter = require('css-declaration-sorter');
...
mix
  ...
  // .ts('src/ts/app.ts', 'assets/js') // use this one for TypeScript instead
  .extract(['jquery', 'popper.js', 'bootstrap', 'workbox-precaching'])
  .sass('src/scss/app.scss', 'assets/css')
  .copy('src/favicon', 'web/assets/favicon')
  .copy('src/robots.txt', 'web/assets')
  .options({
